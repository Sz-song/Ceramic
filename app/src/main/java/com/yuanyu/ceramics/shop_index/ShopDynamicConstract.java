...
public interface ShopDynamicConstract {
    interface IShopDynamicModel {
        Observable<BaseResponse<List<DynamicBean>>> getShopDynamic(String useraccountid, String shop_id, int page);
    ...
    interface IShopDynamicView {
        void getShopDynamicSuccess(List<DynamicBean> beans);
        void getShopDynamicFail(ExceptionHandler.ResponeThrowable e);
    ...
    interface IShopDynamicPresenter {
        void getShopDynamic(String useraccountid, String shop_id, int page);
