...
public class ShopDynamicFragment extends BaseFragment<ShopDynamicPresenter> implements ShopDynamicConstract.IShopDynamicView {
    ...
    @Override
    protected ShopDynamicPresenter initPresent() {
        return new ShopDynamicPresenter();
    }
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    if (lastPosition == recyclerView.getLayoutManager().getItemCount() - 1&&lastPosition>7) {
                        presenter.getShopDynamic(Sp.getString(getContext(),AppConstant.USER_ACCOUNT_ID),shopid,page);
                    }
                }
            }
        });
    ...
    @Override
    public void getShopDynamicSuccess(List<DynamicBean> beans) {
        list.addAll(beans);
        if (isAlive) {
    ...
    @Override
    public void getShopDynamicFail(ExceptionHandler.ResponeThrowable e) {
