...
public class ShopDynamicModel implements ShopDynamicConstract.IShopDynamicModel{
    private HttpService httpService;
    public ShopDynamicModel(){httpService = HttpServiceInstance.getInstance();}

    @Override
    public Observable<BaseResponse<List<DynamicBean>>> getShopDynamic(String useraccountid, String shop_id, int page) {
        ...
        return httpService.getShopDynamic(body);
    }
