...
public class AddressPickerView extends RelativeLayout implements View.OnClickListener {
    ...
    private AddressPickerView.AddressAdapter mAdapter;   // recyclerview 的 adapter
    ...
    private AddressPickerView.OnAddressPickerSureListener mOnAddressPickerSureListener;
    ...
    private void init(Context context) {
        ...
        mAdapter = new AddressPickerView.AddressAdapter();
     ...
     * 下面显示数据的adapter
     */
    class AddressAdapter extends RecyclerView.Adapter<AddressPickerView.AddressAdapter.ViewHolder> {

        @NonNull
        @Override
        public AddressPickerView.AddressAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new AddressPickerView.AddressAdapter.ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_address_text, parent, false));
        }

        @Override
        public void onBindViewHolder(final AddressPickerView.AddressAdapter.ViewHolder holder, final int position) {
    ...
    public void setOnAddressPickerSure(AddressPickerView.OnAddressPickerSureListener listener) {
