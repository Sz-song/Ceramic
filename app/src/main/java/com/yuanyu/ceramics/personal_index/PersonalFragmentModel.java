...
public class PersonalFragmentModel implements PersonalFragmentConstract.IPersonalFragmentModel {
    private HttpService httpService;
    PersonalFragmentModel(){httpService = HttpServiceInstance.getInstance();}
    @Override
    public Observable<BaseResponse<List<DynamicBean>>> initList(String useraccountid, String userid, int page, int type) {
        ...
        map.put("action","personal_dynamic_article");
        ...
        return httpService.getPersonalDynamicArticle(body);
        }
    @Override
