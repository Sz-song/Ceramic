...
public class PersonalIndexModel implements PersonalIndexConstract.IPersonalIndexModel {
    private HttpService httpService;
    PersonalIndexModel(){httpService = HttpServiceInstance.getInstance();}
    @Override
    public Observable<BaseResponse<PersonalIndexBean>> getPersonalIndexData(String useraccountid, String userid) {
        ...
        return httpService.PersonalIndex(body);
    }
    ...
    public Observable<BaseResponse> changeImage(String useraccountid,int type,String url){
        ...
        L.e("str is "+str);
        RequestBody body=RequestBody.create(okhttp3.MediaType.parse("application/json; charset=utf-8"),str);
        return httpService.changeImage(body);
    }
